...
oc new-project pipeline-app-prod --display-name="Pipeline Example - Prod"
...
oc policy add-role-to-group system:image-puller system:serviceaccounts:pipeline-app-prod -n pipeline-app
...
echo "From the CI/CD project - open the Jenkins webconsole, Manage Jenkins->Configure System->OpenShift Jenkins Sync->Namespace and add 'pipeline-app pipeline-app-staging pipeline-app-prod' to the list"
echo ""
